...
function testLogic() {
    ...
    console.log("Mock Now (Brazil Approx): 10:25");
    ...
    for (const timeStr of extractionTimes) {
        ...
        console.log(`  Draw Date (UTC): ${drawDate.toISOString()} (Expected 11:30 or later... 08:15 should be 11:15 UTC)`);

        // 08:15 -> 08+3 = 11:15 UTC.
        // 11:30 -> 14:30 UTC.
        // 12:35 -> 15:35 UTC.
