        ...
        try {
            ...
            if (res.ok) {
                ...
                if (game) {
                    ...
                    showAlert("Jogo Indisponível", "Loteria Tradicional não encontrada no sistema.", "error");
                }
            }
        } catch (error) {
        ...
        <SafeAreaView style={tw`flex-1 bg-background`}>
            ...
            <View style={tw`p-4 border-b border-gray-800 flex-row items-center bg-surface`}>
                ...
                <View style={tw`flex-1`}>
                    <Text style={tw`text-xl font-bold text-center text-white`}>Loteria Tradicional</Text>
